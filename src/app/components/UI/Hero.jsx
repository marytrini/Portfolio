        ...
        <div className='pt-[70px] grid grid-cols-2 gap-x-40 ml-20'>
           ...
           <SectionSubtitle subtitle="-Hello,"/>
            ...
            <div className='text-end relative z-[9]'>
                ...
                <div className='text-left w-[130px] pt-[10px] pr-5 absolute top-1/2 -left-16 rounded-md bg-dark-features opacity-70 z-10 -translate-y-2/4 self-end'>
                ...
                <div className='flex items-center gap-3 w-[150px] absolute bottom-[0.5%] right-24 pt-[10px] pr-5 rounded-md bg-dark-features opacity-70 z-10'>
