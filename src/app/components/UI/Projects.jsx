    ...
    <section id="projects" className="mb-20">
      <div>
        ...
        <div className="grid grid-cols-1 2xl:grid-cols-2 gap-5 sm:flex flex-wrap">
          {" "}
          {/*__row_div__*/}
          <div className="2xl:col-span-1 sm:text-center">
            {" "}
            {/*__col_div__*/}
          ...
          <div className="2xl:col-span-1">
            ...
            <div className="2xl:text-end mr-[15px]">
              <button
                className={`${
                  filter === "Full Stack"
                    ? "dark:bg-dark-features bg-light-secondary_feat border-light-title border-solid border-2 dark:text-dark-text text-light-text"
                    : "dark:bg-dark-bg dark:text-dark-text bg-light-bg text-light-text"
                } text-dark-text rounded-lg p-1.5`}
              ...
              <button
                className={`${
                  filter === "Frontend"
                    ? "dark:bg-dark-features bg-light-secondary_feat border-light-title border-solid border-2 dark:text-dark-text text-light-text"
                    : "dark:bg-dark-bg dark:text-dark-text bg-light-bg text-light-text"
                } text-dark-text rounded-lg p-1.5 mr-2`}
